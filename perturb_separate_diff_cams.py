...
def main():
    ...
    print(f'use diff relevancy map without normalizing first')
    for data_type in TYPES:
        for is_positive_pert in positive_negative_pert_list:
        
            print(f'starting perturb_separate_diff_cams for data_type: {data_type} with is_positive_pert: {is_positive_pert}')
