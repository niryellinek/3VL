...
def main():
    ...
    for data_type in TYPES:
        for is_positive_pert in positive_negative_pert_list:
            ...
            print(f'starting perturb_random_diff for data_type: {data_type} with is_positive_pert: {is_positive_pert}')
            ...
            for name in d.data:
                ...
                for index, batch in enumerate(iterator):
                    ...
                    first_cam = R_image[rand_ind]
                    second_cam = R_image[1-rand_ind]
                    ...
                    cam_image = first_cam - second_cam
