...
def main():
    ...
    print(f'use anchor plus high score(positive or negative) cam to get two scores')
    for data_type in TYPES:
        for is_positive_pert in positive_negative_pert_list:
        
            print(f'starting perturb_anchor_plus_high_score_posneg_cams for data_type: {data_type} with is_positive_pert: {is_positive_pert}')
            ...
            for name in d.data:
                ...
                for index, batch in enumerate(iterator):
                    ...
                    cam_image = cam_image + ancor_cam_image
