...
def main():
    ...
    print(f'use both anchor diff relevancy maps (positive - ancor, negative - ancor) to get two scores')
    for data_type in TYPES:
        for is_positive_pert in positive_negative_pert_list:
        
            print(f'starting perturb_anchor_diff_cams_double_scores for data_type: {data_type} with is_positive_pert: {is_positive_pert}')
